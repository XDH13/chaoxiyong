...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BattleField
					.init("E:\\Javaproject\\hw01\\src\\com\\huawei\\classroom\\student\\h17\\rules.ini");
//					.init("D:\\course\\course\\exam\\src\\main\\java\\com\\huawei\\classroom\\student\\h17\\rules.ini");
			...
			for (int i = 0; i < gameObjects.size(); i++) {
				System.out.println(gameObjects.get(i).playerName+"."+gameObjects.get(i).judge(gameObjects.get(i))+" "+ "live=" + !gameObjects.get(i).isDestroyed() + " x="+ gameObjects.get(i).getX()+" y="+gameObjects.get(i).getY() + " heagth=" + gameObjects.get(i).getHealth());
			}
